...
const CardTypeSelectionModal = ({
  ...
  const handleClick = () => {
    if (selectedPlayer?.uid && selectedCardType) {
      const desiredCard = playerCards[selectedPlayer.uid].find(item => cards[item].type === selectedCardType);

      if (desiredCard) {
        updateDoc(doc(db, "game_rooms_kitten", id), {
          player_cards: { ...playerCards, [selectedPlayer.uid]: playerCards[selectedPlayer.uid].filter(item => item !== desiredCard), [uuid]: [...playerCards[uuid].filter(item => !selectedCards.includes(item)), desiredCard] },
          out_card_deck: arrayUnion(...selectedCards),

          game_moves: arrayUnion({ uid: uuid, cardType: 'combo_3', desiredCard, combo3PlayerUid: selectedPlayer.uid }),
        });
      } else {
        updateDoc(doc(db, "game_rooms_kitten", id), {
          ...
          game_moves: arrayUnion({ uid: uuid, cardType: 'combo_3', combo3PlayerUid: selectedPlayer.uid }),
        });
      }
    }
        ...
        <div className="modal-content">
          <div className="content_block">
            <div
              ...
              className={selectedCardType === cardTypes.defuse ? 'selected' : ''}
            >
            ...
            <div
              ...
              className={selectedCardType === cardTypes.attack ? 'selected' : ''}
            >
            ...
            <div
              ...
              className={selectedCardType === cardTypes.shuffle ? 'selected' : ''}
            >
            ...
            <div
              ...
              className={selectedCardType === cardTypes.seeFuture ? 'selected' : ''}
            >
            ...
            <div
              ...
              className={selectedCardType === cardTypes.tacocat ? 'selected' : ''}
            >
            ...
            <div
              ...
              className={selectedCardType === cardTypes.cattermelon ? 'selected' : ''}
            >
            ...
            <div
              ...
              className={selectedCardType === cardTypes.hairyPotatoCat ? 'selected' : ''}
            >
            ...
            <div
              ...
              className={selectedCardType === cardTypes.beardCat ? 'selected' : ''}
            >
            ...
            <div
              ...
              className={selectedCardType === cardTypes.rainbowRalphingCat ? 'selected' : ''}
            >
            ...
            {expansionsList?.includes(expansions.ImplodingKittens) && (
              <>
                <div
                  ...
                  className={selectedCardType === cardTypes.reverse ? 'selected' : ''}
                >
                ...
                <div
                  ...
                  className={selectedCardType === cardTypes.drawFromTheBottom ? 'selected' : ''}
                >
                ...
                <div
                  ...
                  className={selectedCardType === cardTypes.feral ? 'selected' : ''}
                >
                ...
                <div
                  ...
                  className={selectedCardType === cardTypes.alterTheFuture ? 'selected' : ''}
                >
                ...
                <div
                  ...
                  className={selectedCardType === cardTypes.targetedAttack ? 'selected' : ''}
                >
